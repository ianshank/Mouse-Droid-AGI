...
| USB-C smoke validation gate (PR #106) | [`c4-usbc-smoke.md`](./c4-usbc-smoke.md) | `tests/unit/diagnostics/test_usbc.py`, `tests/unit/diagnostics/test_power_chain.py`, `tests/unit/factory/test_factory_esp32_discovery.py`, `tests/hardware/test_usbc_enumeration.py`, `tests/hardware/test_power_chain_smoke.py` |
| ESP32 command-set codec seam (F-025) | [`c4-esp32-command-set.md`](./c4-esp32-command-set.md) | `tests/unit/comms/test_comms_utils.py`, `tests/unit/comms/test_base_driver.py`, `tests/integration/test_f025_integration.py`, `tests/regression/test_f025_backwards_compat.py`, `tests/regression/test_f025_aqa.py`, `tests/smoke/test_f025_sanity.py`, `tests/hardware/test_motor_smoke.py` |
...
| Sim → RSSM pretraining (MuJoCo CI + opt-in Isaac Lab workstation, F-043+) | [`c4-rssm-sim-pretraining.md`](./c4-rssm-sim-pretraining.md) | `tests/regression/test_f043_aqa.py`, `tests/regression/test_f046_aqa.py`, `tests/e2e/test_rssm_pretrain_backend_gate.py` |
...
| Hailo NPU runtime | `src/mousedroid/hardware/accelerator/hailo_runtime.py` |

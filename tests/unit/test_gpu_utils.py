...
class TestResolveDevice:
    ...
    def test_explicit_cuda_string(self) -> None:
        """Explicit 'cuda:0' returns that device even without GPU."""
        # This just constructs the device object; doesn't check availability
...
class TestLogGpuInfo:
    ...
    @patch("training.gpu_utils.torch.cuda.get_device_properties")
    def test_cuda_logs_info(self, mock_props: MagicMock) -> None:

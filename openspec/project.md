...
|---|---|---|---|---|
| `mouse-droid-deploy-repin` | in progress | F-035 | — | `scripts/repin_tags.sh`, `tests/unit/scripts/test_repin_tags.py`, `scripts/validations/F-035.sh`, `.claude/skills/deploy-repin/SKILL.md`, `deployments/jetson-image.json` (corrected reachability notes), `features.yaml` (F-035) |

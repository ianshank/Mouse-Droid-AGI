...
| `mouse-droid-cloud-egress-default-off` | implemented | F-029 | `pending` | `openspec/changes/mouse-droid-cloud-egress-default-off/peer-review.md`, `tests/regression/test_gcp_egress_defaults_aqa.py`, `scripts/validations/F-029.sh`, `features.yaml` (F-029) |

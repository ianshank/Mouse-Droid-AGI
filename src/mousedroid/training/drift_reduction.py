...
def train_pair_and_compare(
    ...
    *,
    ...
    opt_baseline = torch.optim.Adam(  # type: ignore[attr-defined,unused-ignore]
    ...
    opt_augmented = torch.optim.Adam(augmented_params, lr=learning_rate)  # type: ignore[attr-defined,unused-ignore]

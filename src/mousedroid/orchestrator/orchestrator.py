...
class MouseDroidOrchestrator(
    ...
    def __init__(
        ...
        *,
        ...
        self._telemetry_server = telemetry_server  # type: ignore[assignment]
        ...
        self._on_device_task: asyncio.Task[Any] | None = None  # type: ignore[assignment]
        ...
        self._growth_task: asyncio.Task[Any] | None = None  # type: ignore[assignment]
        ...
        self._consolidation_task: asyncio.Task[Any] | None = None  # type: ignore[assignment]

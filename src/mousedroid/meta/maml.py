...
class MAMLAdapter:
    ...
    def __init__(
        ...
        self._meta_optimizer = torch.optim.Adam(model.parameters(), lr=outer_lr)  # type: ignore[attr-defined,unused-ignore]
    ...
    def adapt(
        ...
        opt = torch.optim.SGD(adapted.parameters(), lr=self._inner_lr)  # type: ignore[attr-defined,unused-ignore]

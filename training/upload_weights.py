...
def upload_weights(
    ...
    *,
    ...
    Uploads ``.pt``, ``.npz``, and ``.json`` files found recursively.
    ...
    extensions = {".pt", ".npz", ".json"}
    files_to_upload = [f for f in weights_dir.rglob("*") if f.is_file() and f.suffix in extensions]
